...
| 01-03-T1 | 01-03 | 3 | REQ-cli-subcommands | T-01-01 | typer pretty_exceptions_show_locals=False + SecretStr through Settings | unit + smoke (typer.CliRunner) | `cd tools/arrconf && uv run pytest tests/test_cli.py -x && uv run arrconf --help \| grep -E '(apply\|dump\|diff\|schema-gen)' \| wc -l \| grep -q 4` | ❌ W3 | ⬜ pending |

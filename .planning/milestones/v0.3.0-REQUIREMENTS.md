...
- [x] **REQ-renovate-app-install**: Mend Renovate App is installed on `github.com/tom333/arr-stack`. First auto-PR on `my-kluster/argocd/argocd-apps/arr-stack-app.yaml#targetRevision` lands within one Renovate scan cycle of a new arr-stack tag (closes D-05.1-BUMP-01 + Phase 5.1 follow-up F2).

...
**Plans**: 4 plans
- [ ] 02.1-01-PLAN.md — Wave 1: Pre-fix snapshot (sonarr+qbittorrent baseline before code change, ADR-6)
...
| 2.1. Field-merge fix for sensitive YAML values | 0/4 | Not started | - |

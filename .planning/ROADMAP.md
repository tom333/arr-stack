...
<details>
<summary>✅ v0.10.0 Couche d'intention (tranche 1) (Phases 28-31) — SHIPPED 2026-05-31</summary>

- [x] Phase 28: Generate foundation (6/6 plans) — 2026-05-31
- [x] Phase 29: Sagas (4/4 plans) — 2026-05-31
- [x] Phase 30: cross-seed (3/3 plans) — 2026-05-31
- [x] Phase 31: qbit_manage (2/2 plans) — 2026-05-31

Total: **4 phases, 15/15 plans complete, 115 commits, ~6.5h same-day**.
...
<details>
<summary>Archived v0.10.0 phase details (pre-collapse)</summary>
...
- [x] 28-05-PLAN.md — generate-idempotence CI guard job + tests.yml path trigger (INTENT-03)
...
| v0.10.0 Couche d'intention (tranche 1) | 4 | 15/15 | ✅ Shipped | 2026-05-31 |
